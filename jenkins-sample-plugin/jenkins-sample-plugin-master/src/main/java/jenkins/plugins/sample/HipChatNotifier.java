...
public class HipChatNotifier extends Notifier {
    ...
    public static class DescriptorImpl extends BuildStepDescriptor<Publisher> {
        ...
        public HipChatNotifier newInstance(StaplerRequest sr) {
           if (token == null) token = sr.getParameter("sampleToken");
           if (buildServerUrl == null) buildServerUrl = sr.getParameter("sampleBuildServerUrl");
           if (room == null) room = sr.getParameter("sampleRoom");
          if (sendAs == null) sendAs = sr.getParameter("sampleSendAs");
              // token = "uu";
          //  room = "testrooma";
        ...
        public boolean configure(StaplerRequest sr, JSONObject formData) throws FormException {
            token = sr.getParameter("sampleToken");
            room = sr.getParameter("sampleRoom");
            buildServerUrl = sr.getParameter("sampleBuildServerUrl");
            sendAs = sr.getParameter("sampleSendAs");
          //  token = "uu";
           // room = "testrooma";
          //  buildServerUrl = "127.0.0.1:8080";
            //sendAs = "anitha";
        ...
        public String getDisplayName() {
            return "sample msg Notifications";
        }
    }
